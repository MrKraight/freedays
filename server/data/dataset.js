...
var tgRoute = new route(
    ...
    [new point("Начало тропы","49.91","86.55"), new point("Вода (озерцо) на подъеме на перевал Ярлу-Боч","49.93","86.58"),new point("Перевал Ярлу-Боч","49.925314","86.61"),new point("Ручей","49.91","86.62"),new point("Ручей2","49.91","86.62"), new point("Перемычка при подъеме на перевал Кара-Айры Южный","49.89","86.65"), new point("Перевал Кара-Айры Южный","49.891","86.66")]
)

var ecoRoute = new route(
    "3",
    "Перевал Кара-Айры Южный - Перевал Титова",
    [new point("Перевал Кара-Айры Южный","49.891","86.66"),new point("Перевал ОКА","49.890","86.67"),new point("ручей3","49.86","86.71"), new point("Перевал Титова","49.83","86.60")]
)
